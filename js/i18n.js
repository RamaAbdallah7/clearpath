...
(function () {
  const STRINGS = {
    en: {
      ...
      "needs.h": "Which route suits you?",
      "needs.sub": "Tell me what matters and I'll pick the route that fits — and say why it won.",
      "needs.cta": "Find my best route",
      "needs.clear": "Clear",
      "needs.working": "Comparing routes…",
      "needs.best": "Best for you",
      "needs.alt": "Also possible",
      "needs.show": "Show on map",
      "needs.none": "Pick at least one, or I'll assume no particular need.",
      "needs.scored": "Scored on what you chose",
      "vr.cta": "Walk the park in VR",
      "vr.note": "Works on a headset, or drag to look on a phone or laptop.",
      "vr.next": "Next stop →",
      "vr.prev": "← Back",
      "vr.replay": "Say it again",
      "vr.headset": "Headset detected — press Enter VR",
    ...
    ar: {
      ...
      "needs.h": "أي مسار يناسبك؟",
      "needs.sub": "أخبرني بما يهمّك وسأختار المسار المناسب — وأوضّح سبب اختياره.",
      "needs.cta": "اعثر على أفضل مسار لي",
      "needs.clear": "مسح",
      "needs.working": "أقارن المسارات…",
      "needs.best": "الأفضل لك",
      "needs.alt": "خيارات أخرى ممكنة",
      "needs.show": "اعرضه على الخريطة",
      "needs.none": "اختر واحداً على الأقل، وإلا افترضتُ عدم وجود احتياج محدّد.",
      "needs.scored": "مُقيَّم وفق ما اخترته",
      "vr.cta": "تجوّل في الحديقة بالواقع الافتراضي",
      "vr.note": "يعمل على نظارة الواقع الافتراضي، أو اسحب للنظر حولك على الهاتف أو الحاسوب.",
      "vr.next": "المحطة التالية ←",
      "vr.prev": "→ رجوع",
      "vr.replay": "أعد القول",
      "vr.headset": "تم اكتشاف نظارة — اضغط «ادخل الواقع الافتراضي»",
